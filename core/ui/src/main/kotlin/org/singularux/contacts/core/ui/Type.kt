...
private val displayFontFamily = FontFamily(
    Font(resId = R.font.pt_serif_regular, weight = FontWeight.Normal, style = FontStyle.Normal),
    Font(resId = R.font.pt_serif_regular_italic, weight = FontWeight.Normal, style = FontStyle.Italic),
    Font(resId = R.font.pt_serif_medium, weight = FontWeight.Medium, style = FontStyle.Normal),
...
private val bodyFontFamily = FontFamily(
    ...
    Font(resId = R.font.inter_regular_italic, weight = FontWeight.Normal, style = FontStyle.Italic),
...
internal val ContactsTypography = Typography(
